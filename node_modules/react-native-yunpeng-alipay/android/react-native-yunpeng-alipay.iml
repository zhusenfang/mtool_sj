...
<module external.linked.project.id=":react-native-yunpeng-alipay" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-yunpeng-alipay" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/workplace/github/mtool_sj/node_modules/react-native-yunpeng-alipay/android/libs/alipaySdk-20160223.jar:unspecified@jar" level="project" />
