...
<module external.linked.project.id=":jcore-react-native" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/workplace/github/mtool_sj/node_modules/jcore-react-native/android/libs/jcore-android-1.1.7.jar:unspecified@jar" level="project" />
