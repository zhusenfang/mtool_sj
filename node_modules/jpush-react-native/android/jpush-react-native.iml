...
<module external.linked.project.id=":jpush-react-native" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/workplace/github/mtool_sj/node_modules/jpush-react-native/android/libs/jpush-android-3.0.9.jar:unspecified@jar" level="project" />
